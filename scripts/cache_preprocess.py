...
IMPORTANT !!!!! 90% MADE BY AI, SO PROBABLY NOT THE BEST CODE, BUT IT WORKS :)

Run before train to convert everything into mfcc files locally on your computer in "data_cache" as to not bottleneck:)
Else it will do it everytime you run train, which will slow it down a lot.

It skips files that are already cached, so its pretty mlops as it can cache new data if ya wanna B)
to use, write:
